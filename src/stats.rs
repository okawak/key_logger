...
mod tests {
    ...
    fn test_add_many_function() {
        ...
        add_many(&stats, keys.into_iter()).unwrap();
    ...
    fn test_large_counts() {
        ...
        add_many(&stats, large_keys.into_iter()).unwrap();
    ...
    fn test_special_characters_cross_platform() {
        ...
        let special_keys = vec![
            ...
            "LeftAlt", "RightAlt", "ArrowUp", "ArrowDown", "ArrowLeft", "ArrowRight",
            "Comma", "Period", "Semicolon", "Minus", "Equal", "LeftBracket", "RightBracket"
        ];
        ...
        for &key in &special_keys {
            assert_eq!(snapshot.get(key), Some(&1), "Key '{}' was not recorded", key);
        }
