...
pub const U2MM: f64 = 19.05; // u -> mm
pub const U2CELL: usize = 4; // u -> cell
pub const U2PX: f64 = 60.0; // u -> px (for visualization)
...
/// Visualization
pub const MARGIN: f64 = 24.0; // margin [px]
pub const LEGEND_WIDTH: f64 = 320.0; // legend width [px]
pub const FONT_SIZE: f64 = 16.0; // font size [px]

/// calculate cell start position \[cell\] to \[mm\]
/// - row: u unit
/// - col: cell unit
#[inline]
pub fn cell_to_coordinate(row: usize, col: usize) -> (f64, f64) {
    let x = (col as f64 / U2CELL as f64) * U2MM;
    let y = row as f64 * U2MM;
    (x, y)
}
...
/// - width: \[u\]
#[inline]
pub fn cell_to_key_center(row: usize, col: usize, width: f64) -> (f64, f64) {
